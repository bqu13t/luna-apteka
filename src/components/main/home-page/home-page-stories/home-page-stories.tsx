...
export default function HomePageStories() {
  ...
  return (
    <div className="main__stories">
      <ul className="main__stories__list">
        {storiesList.map(
          ({
            id,
            title,
            ...
            <li
              key={id}
              className="main__stories__list__story relative"
              onClick={() => {
            ...
            >
              <div
                className={`ping-icon ${!visitedItems.includes(id) ? "visible" : ""
                  }`}
              >
            ...
            <div className="flex min-h-full items-center justify-center p-0 text-left">
              {isOpen && (
                ...
                >
                  ...
                  <button
                    type="button"
                    className="absolute right-[11px] top-[11px] rounded-lg bg-white p-1.5 text-gray-800"
                    onClick={closeModal}
                  >
