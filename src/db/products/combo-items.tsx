...
const comboItems: ComboItem[] = [
  ...
  },
  {
    id: 'pizza-03',
    name: 'Гавайский микс',
    description: 'Гавайская пицца с ананасами и ананасовый сок! Идеально, когда хочешь сладенького, но не знаешь чего именно)',
    price: 939,
    is_promo: true,
    is_new: false,
    is_top: false,
  ...
  },
  {
    id: 'pizza-04',
    name: 'Топ 5 комбо',
    description: '5 пицц, покорившие ваши сердечки, в одном комбо! Барбекю, Делюкс, Острый Микс, Копченый ципленок, Манхэттен',
    price: 3199,
    is_promo: true,
    is_new: false,
    is_top: false,
